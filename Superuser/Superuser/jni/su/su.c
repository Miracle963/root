...
static void user_init(struct su_context *ctx) {
    // /data/data/com.koushikdutta.superuser/databases/su.sqlite
    //  /data/user/[userid]/com.koushikdutta.superuser/databases/su.sqlite
    
    //  如果superuser的功能都放到了Settings里
    //  /data/data/com.android.settings/databases/su.sqlite
...
//  第一阶段
    ...
    ctx.umask = umask(027);
    //  在/dev目录下创建一个用于LocalSocket缓存的目录
